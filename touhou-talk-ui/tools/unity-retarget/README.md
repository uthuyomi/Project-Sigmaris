...
- Names are normalized to include the source asset filename (Mixamo clips often share internal names)

## Fix SkinnedMeshRenderer bindings (common import issue)

If a VRM prefab looks “exploded” or skinning is broken, try:
