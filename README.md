...
Instead of relying on “whatever the model does inside a chat session”, Sigmaris treats the model as a component and keeps critical concerns **outside the model** as explicit software:
...
- A real product-shaped integration (UI + persistence + optional world simulation modules)
...
## Environment variables (how to keep them sane)
